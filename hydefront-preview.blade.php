...
<p>HydePHP is a content-first Laravel-powered Static Site Builder that allows you to create static HTML pages, blog posts, and documentation sites using Markdown.
Hyde is all about letting you get started quickly while giving you the power and freedom of doing things the way you want to.</p>
...
<p>See the documentation and learn more at <a href="https://hydephp.github.io/docs/">https://hydephp.github.io/docs/</a></p>
<h2>Features</h2>
...
<ul>
<li>The Hyde starter comes with <a href="https://github.com/hydephp/hydefront/">HydeFront</a> to serve the base stylesheet and JavaScript through the jsDelivr CDN.</li>
<li>Hyde ships with precompiled and minified TailwindCSS styles in the app.css file, you can also load them through the CDN.</li>
<li>This means that all the styles you need are already installed. However, if you want to customize the Tailwind config, or if you add new Tailwind classes through Blade files, you can simply run the <code>npm run dev</code> command to recompile the styles using Laravel Mix.</li>
</ul>
<h3>Customization</h3>
<ul>
...
<p>The Hyde site (<a href="https://hydephp.github.io/">https://hydephp.github.io/</a>) is fully built with Hyde. That includes the homepage, the blog, and the documentation.
You can also take a look at the <a href="https://hydephp.github.io/gallery">Gallery page</a> which was created using the Blade page module in Hyde and contains interactive graphics showcasing Hyde.</p>
<h3>Demo video showcasing how to scaffold a blog post and compile it to static HTML</h3>
<p><a href="https://www.youtube.com/watch?v=gjpE1U527h8"><img src="https://user-images.githubusercontent.com/95144705/163714609-8d636acd-3538-47e9-a6f3-1923b375338b.png" title="Watch on YouTube" alt="YouTube Thumbnail" width="40%"></a></p>
<h2>Getting Started - High-level overview</h2>
<blockquote>
<p>See <a href="https://hydephp.github.io/docs/master/installation.html">Installation Guide</a> and <a href="https://hydephp.github.io/docs/master/getting-started.html">Getting Started</a> for the full details.</p>
</blockquote>
...
<p>Next, place your Markdown files in one of the content directories:  <code>_posts</code>, <code>_docs</code>, and <code>_pages</code> which also accepts Blade files. You can also use use the <code>hyde:make</code> command to scaffold them.</p>
<p>When you're ready, run the build command to compile your static site which will save your HTML files in the <code>_site</code> directory.</p>
<pre><code class="language-bash">php hyde build
</code></pre>
<h2>⚠ Beta Software Warning</h2>
<p>Heads up! HydePHP is still new and currently in beta. Please report any bugs and issues in the appropriate issue tracker. Versions in the 0.x series might not be stable and may change at any time. No backwards compatibility guarantees are made and there will be breaking changes without notice.</p>
<p>Please wait until v1.0 for production use and remember to back up your source files before updating (use Git!).
See <a href="https://hydephp.github.io/docs/master/updating-hyde.html">https://hydephp.github.io/docs/master/updating-hyde.html</a> for the upgrade guide.</p>
<h2>Resources</h2>
<h3>Changelog</h3>
...
<h3>Security</h3>
<p>If you discover any security-related issues, please email <a href="mailto:caen@desilva.se">caen@desilva.se</a> instead of using the issue tracker.
...
<ul>
<li>The Hyde core is built with <a href="https://laravel-zero.com/">Laravel Zero</a> which is based on <a href="https://laravel.com/">Laravel</a>
</li>
<li>The frontend is built with <a href="https://tailwindcss.com/">TailwindCSS</a>.</li>
<li>The dark mode switch is based on a component from <a href="https://flowbite.com/docs/customize/dark-mode/">Flowbite</a>.</li>
</ul>
...
<main id="content" class="mx-auto max-w-7xl py-16 px-8">
	<article aria-label="Article" id="posts/my-new-post" itemscope="" itemtype="https://schema.org/Article" class="post-article mx-auto prose dark:prose-invert">
    ...
    <header aria-label="Header section" role="doc-pageheader">
		...
		<div id="byline" aria-label="About the post" role="doc-introduction">
            Posted <time itemprop="dateCreated datePublished" datetime="2022-04-12T17:55:00+00:00" title="Tuesday Apr 12th, 2022, at 5:55pm">Apr 12th, 2022</time>
		    by author
<address itemprop="author" itemscope="" itemtype="https://schema.org/Person" aria-label="The post author" style="display: inline;"> 
    ...
    <figcaption aria-label="Image caption" itemprop="caption"> 
        Image by <span itemprop="creator" itemscope="" itemtype="https://schema.org/Person"><a href="https://pixabay.com/photos/kitten-gray-kitty-kitty-756956/" rel="author noopener" itemprop="url"><span itemprop="name">Godsgirl_madi</span></a></span>. <span itemprop="copyrightNotice">Copyright (c) 2022</span>. License <a href="https://pixabay.com/service/license/" rel="license nofollow noopener" itemprop="license">Pixabay License</a> 
    </figcaption> 
...
<h3>Images</h3>
<p><img src="https://raw.githubusercontent.com/hydephp/hydephp.github.io/gh-pages/media/kitten-756956_640-min.jpg" alt="Alt title" title="Caption"></p>
<h3>Links</h3>
...
<hr><mark>Documentation page</mark> Markdown from: https://github.com/tailwindlabs/tailwindcss-typography/blob/master/demo/components/MarkdownSample.mdx (License MIT)
<main id="content" class="mx-auto max-w-7xl py-16 px-8">
	<article aria-label="Article" id="posts/tailwind-typography-demo" itemscope="" itemtype="https://schema.org/Article" class="post-article mx-auto prose dark:prose-invert">
    <meta itemprop="identifier" content="tailwind-typography-demo">
        
    <header aria-label="Header section" role="doc-pageheader">
        <h1 itemprop="headline" class="mb-4">Tailwind Typography Demo</h1>
		<div id="byline" aria-label="About the post" role="doc-introduction">
            Posted <time itemprop="dateCreated datePublished" datetime="2022-05-01T16:00:00+00:00" title="Sunday May 1st, 2022, at 4:00pm">May 1st, 2022</time>
		    by author
<address itemprop="author" itemscope="" itemtype="https://schema.org/Person" aria-label="The post author" style="display: inline;"> 
